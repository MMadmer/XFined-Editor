...
| `xfined_quest_layout` | deterministic pin-aware top-down layout; separates complete nested branch bounds and complete trigger trees (`all:false` = only nodes without `pos`); returns the positions |
