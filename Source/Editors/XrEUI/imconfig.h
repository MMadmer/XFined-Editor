...
// XFined keeps the ImGui ABI in XrEUI. This config is consumed by every
// producer and consumer so exports and texture handles cannot drift by TU.
#if defined(XREUI_EXPORTS)
...
// The official backends bind these native resources directly. Forward
// declarations keep this config lightweight while preserving the typed ABI.
#if defined(USE_DX11)
struct ID3D11ShaderResourceView;
#define ImTextureID ID3D11ShaderResourceView*
#else
struct IDirect3DBaseTexture9;
#define ImTextureID IDirect3DBaseTexture9*
#endif
