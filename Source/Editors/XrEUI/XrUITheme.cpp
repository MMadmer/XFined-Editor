...
void ApplyDarkPalette(ImGuiStyle& style, const ThemePalette& palette)
{
	...
	colors[ImGuiCol_TabActive] = Hex(0x403b56);
	colors[ImGuiCol_TabUnfocused] = Hex(0x1d1c22);
	colors[ImGuiCol_TabUnfocusedActive] = Hex(0x302d3b);
	...
	colors[ImGuiCol_NavHighlight] = Hex(palette.accent_active);
