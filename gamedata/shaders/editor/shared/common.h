...
//
// Shader model 4 has no 'half' - the type is an alias for float and only costs
// truncation warnings, so everything below is spelled out as float.
...
// D3DCOLOR vertex elements arrive as R8G8B8A8_UNORM under D3D11, so the
// channels have to be put back in D3D9 order by hand.
